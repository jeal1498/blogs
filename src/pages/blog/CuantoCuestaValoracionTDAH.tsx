          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-gradient-primary flex items-center justify-center text-primary-foreground font-serif font-bold italic text-3xl shadow-lg">
                  K
                </div>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground mb-2">Sobre la autora</p>
                <p className="text-sm text-muted-foreground font-light leading-relaxed">
                  Este artículo fue elaborado por la <strong className="text-primary">Psic. Karen Trujillo</strong>, neuropsicóloga
                  especializada en valoración de TDAH y Autismo en Cancún, Quintana Roo. Con más de 7 años de experiencia clínica,
                  cédula profesional federal <strong className="text-primary">11009616</strong> y formación en la Universidad Modelo de
                  Quintana Roo. Utiliza instrumentos estandarizados internacionales en todos sus procesos de evaluación.
                </p>
              </div>
            </motion.div>
          </div>
