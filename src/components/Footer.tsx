...
const Footer = () => {
  const valoraciones = [
    { to: '/evaluacion-tdah-ninos', label: 'Valoración TDAH Infantil' },
    { to: '/evaluacion-tdah-adultos', label: 'Valoración TDAH Adultos' },
    { to: '/evaluacion-autismo-cancun', label: 'Diagnóstico Autismo (TEA)' },
  ];
    ...
    <footer id="contacto" className="bg-gradient-primary text-primary-foreground pt-24 pb-12 px-6 overflow-hidden relative">
      ...
      >
        ...
        <div className="md:col-span-1">
          <Link to="/" className="block w-12 h-12 bg-primary-foreground rounded-lg flex items-center justify-center text-primary font-serif font-bold italic text-2xl mb-6">K</Link>
          <p className="text-xs text-primary-foreground/70 leading-relaxed mb-6">
            Neuropsicóloga especializada en valoración de TDAH y Autismo en Cancún. Diagnóstico con instrumentos estandarizados internacionales. Cédula Federal: 11009616.
          </p>
          <div className="flex gap-3">
            <a href="https://www.facebook.com/share/1Bs93MjeKt/" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-foreground/10 hover:bg-accent-blue rounded-lg flex items-center justify-center transition-all hover:scale-110" title="Facebook">
              <Facebook className="w-5 h-5" />
            </a>
            <a href="https://www.instagram.com/psicologakarentrujillo" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-foreground/10 hover:bg-accent-pink/60 rounded-lg flex items-center justify-center transition-all hover:scale-110" title="Instagram">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="https://www.tiktok.com/@psic.karentrujillo" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 bg-primary-foreground/10 hover:bg-accent-blue rounded-lg flex items-center justify-center transition-all hover:scale-110" title="TikTok">
              <TikTokIcon />
            </a>
          </div>
        </div>
        ...
        {/* Valoraciones links */}
        <div className="md:col-span-1">
          <h4 className="font-bold uppercase tracking-widest text-xs mb-6 text-accent-blue">Valoraciones</h4>
          <ul className="space-y-3 text-xs font-medium text-primary-foreground/70">
            {valoraciones.map((v) => (
              <li key={v.to}>
                <Link to={v.to} className="hover:text-primary-foreground hover:translate-x-1 transition-all inline-block">
                  {v.label}
                </Link>
              </li>
            ))}
        ...
        <div className="md:col-span-2">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            <a href="mailto:karentrujillopsic@gmail.com"
              className="flex items-center gap-4 p-4 rounded-lg bg-primary-foreground/5 hover:bg-accent-blue/20 transition-all group border border-primary-foreground/10">
              <div className="bg-primary-foreground/10 group-hover:bg-primary-foreground/20 p-3 rounded-lg text-accent-blue group-hover:text-primary-foreground transition-colors">
